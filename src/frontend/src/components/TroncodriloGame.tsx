...
// Minijuego "esquiva troncos" en canvas puro — usado por la 404 (NotFoundPage) y
// por la pantalla de mantenimiento (MaintenancePage). El copy de alrededor lo
// decide cada página que lo monta; este componente es solo el canvas.
export default function TroncodriloGame() {
